    ...
    <div class="row justify-content-center features">
        <div class="col-sm-6 col-md-5 col-lg-4 item">
            <div class="box"><?= $this->Icon->iconHtml('address-book', ['icon']) ?>
                ...
                <?php if ($this->Identity->isLoggedIn()) : ?><a class="learn-more" href="<?= $this->Url->build(['controller' => 'Users', 'action' => 'search']) ?>">Search for a Member »</a><?php endif; ?>
            </div>
        </div>
        <div class="col-sm-6 col-md-5 col-lg-4 item">
            <div class="box"><?= $this->Icon->iconHtml('paw', ['icon']) ?>
                ...
                <?php if ($this->Identity->isLoggedIn()) : ?><a class="learn-more" href="<?= $this->Url->build(['controller' => 'Sections', 'action' => 'search']) ?>">Search for a Section »</a><?php endif; ?>
            </div>
        </div>
        <div class="col-sm-6 col-md-5 col-lg-4 item">
            <div class="box"><?= $this->Icon->iconHtml('sitemap', ['icon']) ?>
                ...
                <?php if ($this->Identity->isLoggedIn()) : ?><a class="learn-more" href="<?= $this->Url->build(['controller' => 'ScoutGroups', 'action' => 'index']) ?>">Whats going on »</a><?php endif; ?>
            </div>
        </div>
    </div>
</div>
