...
class CognitoAuthenticator extends AbstractAuthenticator
{
    ...
    public const CREDENTIAL_TOKEN = 'cognito_token';
    ...
    protected array $_defaultConfig = [
        ...
        'fields' => [
            ...
            self::CREDENTIAL_TOKEN => 'cognito_token',
        ],
    ];
    ...
    protected function _getData(ServerRequestInterface $request): ?array
    {
        ...
        if (key_exists(self::CREDENTIAL_TOKEN, $body)) {
            return $data[self::CREDENTIAL_TOKEN] = $body[self::CREDENTIAL_TOKEN];
        }

        unset($fields[self::CREDENTIAL_TOKEN]);
    ...
    public function authenticate(ServerRequestInterface $request): ResultInterface
    {
        ...
        return $this->doAuthentication($data);
    }
