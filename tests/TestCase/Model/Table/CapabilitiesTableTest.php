            ...
            'Installed' => [
                [
                    ...
                    'Field' => [
                        ...
                        'FIELD_CHANGE_USER@ALL_ROLE_COUNT' => 'Change field "All Role Count" on a User',
                        'FIELD_CHANGE_USER@ACTIVE_ROLE_COUNT' => 'Change field "Active Role Count" on a User',
                        'FIELD_CHANGE_USER@ALL_EMAIL_COUNT' => 'Change field "All Email Count" on a User',
                        'FIELD_CHANGE_USER@ALL_PHONE_COUNT' => 'Change field "All Phone Count" on a User',
                        'FIELD_CHANGE_USER@RECEIVE_EMAILS' => 'Change field "Receive Emails" on a User',
                        'FIELD_VIEW_USER@ALL_ROLE_COUNT' => 'View field "All Role Count" on a User',
                        'FIELD_VIEW_USER@ACTIVE_ROLE_COUNT' => 'View field "Active Role Count" on a User',
                        'FIELD_VIEW_USER@ALL_EMAIL_COUNT' => 'View field "All Email Count" on a User',
                        'FIELD_VIEW_USER@ALL_PHONE_COUNT' => 'View field "All Phone Count" on a User',
                        'FIELD_VIEW_USER@RECEIVE_EMAILS' => 'View field "Receive Emails" on a User',
                        'FIELD_CHANGE_USER@VALIDATED_EMAIL_COUNT' => 'Change field "Validated Email Count" on a User',
                        ...
                        'FIELD_CHANGE_USER@SEARCH_STRING' => 'Change field "Search String" on a User',
                        'FIELD_CHANGE_USER@TAG_COUNT' => 'Change field "Tag Count" on a User',
                        'FIELD_VIEW_USER@SEARCH_STRING' => 'View field "Search String" on a User',
                        'FIELD_VIEW_USER@TAG_COUNT' => 'View field "Tag Count" on a User',
                    ],
                ],
                true,
            ],
