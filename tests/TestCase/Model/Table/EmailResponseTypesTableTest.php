...
class EmailResponseTypesTableTest extends TestCase
{
    ...
    {
        parent::setUp();
        $config = $this->getTableLocator()->exists('EmailResponseTypes') ? [] : ['className' => EmailResponseTypesTable::class];
        $this->EmailResponseTypes = $this->getTableLocator()->get('EmailResponseTypes', $config);
    }
